  ...
  return (
    <div>
      ...
      <textarea
        ...
        rows={12}
        className={`mt-2 block w-full resize-y rounded-lg border bg-zinc-50 px-3 py-2.5 font-mono text-sm leading-6 text-zinc-900 placeholder:text-zinc-500 focus:ring-2 focus:outline-none ${
          error
