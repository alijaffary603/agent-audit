  ...
  return (
    <div>
      ...
      <textarea
        ...
        rows={3}
        className={`mt-2 block w-full resize-y rounded-lg border bg-zinc-800/50 px-3 py-2.5 text-sm text-zinc-100 placeholder:text-zinc-500 focus:ring-2 focus:outline-none ${
          error
